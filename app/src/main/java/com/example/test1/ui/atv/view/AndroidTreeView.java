package com.example.test1.ui.atv.view;
...
import com.example.test1.ui.atv.holder.SimpleViewHolder;
import com.example.test1.ui.atv.model.TreeNode;
import com.example.test1.ui.atv.view.TwoDScrollView;
...
public class AndroidTreeView {
    ...
    public View getView(int style) {
        ...
        if (style > 0) {
            ...
            view = use2dScroll ? new com.unnamed.b.atv.view.TwoDScrollView(newContext) : new ScrollView(newContext);
        } else {

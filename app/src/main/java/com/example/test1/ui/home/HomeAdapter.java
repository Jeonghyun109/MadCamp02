...
public class HomeAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = myinf.inflate(this.groupLayout, parent, false); // parent
        }
        ExpandableListView groupName = (ExpandableListView)convertView.findViewById(R.id.first_reply);
//        groupName.setText(DataList.get(groupPosition).groupName); 여기에 parent expandablelistview 실행해줘야 할까?
        return convertView;
    }
